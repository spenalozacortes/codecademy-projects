...
public class MedievalGame {
  ...
  private Player start(Scanner console) {
    ...
    while (!answer.equals("y") && !answer.equals("n")) {
      System.out.println("Sorry adventurer, I only speak the common tongue. Please enter 'y' to load a game or 'n' to start a new game: ");
      answer = console.next().toLowerCase();
    }
    if (answer.equals("y")) {
      System.out.println("\nAhh... I knew I remembered you, what was your name again? Let me see if I can find your backpack: ");
      String name = console.next();
      player = this.load(name, console);
    } else {
