...
for transaction in daily_transactions_split:
  ...
  for data_point in transaction:
    transaction_stripped.append(data_point.strip())
...
for color in colors:
  print("Thread Shed sold {count} threads of {color} thread today.".format(color=color, count=color_count(color)))